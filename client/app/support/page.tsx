                ...
                <div className="max-w-[1200px] mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[800px] mx-auto text-left">
                        <div className="bg-white p-12 rounded-[3rem] border border-blue-100 shadow-2xl shadow-blue-900/5 group hover:border-blue-900 transition-all">
                            ...
                            <a href="mailto:support@jobnexa.com" className="text-[10px] font-black uppercase tracking-widest text-blue-900 underline">support@jobnexa.com</a>
                        </div>
                        <div className="bg-white p-12 rounded-[3rem] border border-blue-100 shadow-2xl shadow-blue-900/5 group hover:border-blue-900 transition-all">
                            ...
                            <a href="mailto:partners@jobnexa.com" className="text-[10px] font-black uppercase tracking-widest text-blue-900 underline">partners@jobnexa.com</a>
                        </div>
                    </div>
                </div>
            </main>
