            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <Link href="/dashboard/applications" className="text-blue-400 hover:text-blue-900 transition-colors">
                                ...
                                <div key={stage.id} className={`p-6 rounded-2xl border transition-all ${index <= currentStageIndex ? 'bg-white border-blue-100 shadow-sm' : 'bg-blue-50 border-transparent opacity-50'
                                    ...
                                    <div className="flex justify-between items-start mb-6">
                                        <span className={`text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded ${index < currentStageIndex ? 'bg-emerald-50 text-emerald-600' :
                                            index === currentStageIndex ? 'bg-blue-900 text-white' : 'bg-blue-100 text-blue-400'
                                            }`}>
