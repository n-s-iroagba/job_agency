...
export default function ApplicantDashboard() {
    ...
    if (isLoading) return <div className="p-12 text-center text-[10px] font-bold uppercase tracking-widest text-blue-400 animate-pulse">Synchronizing Dashboard Nodes...</div>;
    ...
    return (
        <div className="font-sans antialiased text-blue-900 selection:bg-blue-100 selection:text-blue-900">
            <div className="mb-12">
                ...
                <p className="text-[10px] font-black text-blue-400 uppercase tracking-[0.3em] mt-2">Operational Oversight / Active Career Nodes</p>
            </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                    <section>
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 pb-6 border-b border-blue-50">
                            <div>
                                <h2 className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em]">Application Pipeline</h2>
                                <p className="text-[9px] text-blue-300 font-bold uppercase mt-1">{filteredStages.length} Nodes Displayed</p>
                            </div>
                        ...
                        <div className="space-y-4">
                                ...
                                <div key={app.applicationId} className="bg-white p-6 rounded-[2rem] border border-blue-100 shadow-sm transition-all hover:shadow-xl hover:shadow-blue-900/5 hover:border-blue-900/20">
                                    <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-8">
                                        ...
                                        <div className="text-right">
                                            <div className="text-[9px] font-black text-blue-300 uppercase tracking-widest mb-1">Integrity Map</div>
                            ...
                            {filteredStages.length === 0 && (
                                <div className="py-20 text-center bg-blue-50/50 rounded-[3rem] border-2 border-dashed border-blue-100">
                                    ...
                                    <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest">No matching infrastructure nodes in this filter</p>
                                    <button 
                ...
                <div className="space-y-8">
                    {summary?.allPayments?.length > 0 && (
                        <section className="bg-white p-6 rounded-[2.5rem] border border-blue-100 shadow-sm overflow-hidden animate-in fade-in slide-in-from-right-4 duration-500">
                            <h2 className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em] mb-8 pb-4 border-b border-blue-50">Settlement Registry</h2>
                                    ...
                                    <div key={pay.id} className="p-4 bg-blue-50/50 border border-blue-100 rounded-2xl group hover:bg-white hover:shadow-lg hover:shadow-blue-900/5 transition-all">
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            <span className={`text-[8px] font-black uppercase tracking-widest px-2 py-0.5 rounded-lg border ${
                                                pay.status === 'Verified' || pay.status === 'Paid' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' :
                    ...
                    <section className="bg-white p-6 rounded-[2.5rem] border border-blue-100 shadow-sm animate-in fade-in slide-in-from-right-8 duration-700">
                        <h2 className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em] mb-8 pb-4 border-b border-blue-50">Target Opportunities</h2>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-blue-900/95 backdrop-blur-md animate-in fade-in duration-300">
                    <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh] border border-white/20">
                        <div className="p-8 bg-white border-b border-blue-50 flex items-center justify-between">
                            <div>
                                <h3 className="text-xs font-black text-blue-900 uppercase tracking-widest">Financial Portal</h3>
                                <p className="text-[9px] font-bold text-blue-400 uppercase mt-1">Ref ID: #CC-{selectedPaymentApp.applicationId.toString().padStart(5, '0')}</p>
                            </div>
                            ...
                            {getPaymentForApp(selectedPaymentApp) ? (
                                ...
                                <div className="p-12 text-center">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-widest text-red-500">
                                        Node Error: No settlement record detected for this stage.
                                    </p>
                                </div>
                            )}
                        </div>
