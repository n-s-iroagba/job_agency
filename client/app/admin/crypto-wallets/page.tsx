                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-blue-50">
                            {walletList.map((wallet: CryptoWallet) => (
                                <tr key={wallet.id} className="hover:bg-blue-50/50 transition-colors group">
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-sm font-medium text-blue-900">{wallet.displayLabel}</span>
                                                <span className="text-[9px] font-bold text-blue-400 uppercase tracking-widest">{wallet.currencyName}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                        <div className="flex flex-col">
                                            <span className="text-[11px] font-mono text-blue-600 break-all max-w-[200px]">{wallet.walletAddress}</span>
                                            <span className="text-[9px] font-bold text-blue-400 uppercase tracking-widest mt-0.5">{wallet.networkType}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-6 py-5 text-right">
                                        <div className="flex justify-end gap-3">
                                            <Link href={`/admin/crypto-wallets/${wallet.id}`} className="text-[10px] font-bold text-blue-400 uppercase tracking-widest hover:text-blue-900 transition-colors">
                                                View
                                            </Link>
                                            <Link href={`/admin/crypto-wallets/${wallet.id}/edit`} className="text-[10px] font-bold text-blue-400 uppercase tracking-widest hover:text-blue-600 transition-colors">
                                                Edit
                                            </Link>
                                            <button
